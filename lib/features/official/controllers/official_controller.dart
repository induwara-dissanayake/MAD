...
final approveRequestProvider =
    ...
    >((ref, params) async {
      ...
      await service.approveRequest(
        ...
        appointmentStartAt: params.appointmentStartAt,
        appointmentEndAt: params.appointmentEndAt,
      );
...
final rejectRequestProvider =
    FutureProvider.family<
      void,
      ({String requestId, String rejectionReason, String approverUid})
    >((ref, params) async {
      final service = ref.read(requestApprovalServiceProvider);
...
final requestMoreInfoProvider =
    FutureProvider.family<void, ({String requestId, String infoNeeded})>((
      ref,
      params,
    ) async {
      final repository = ref.watch(officialRepositoryProvider);
